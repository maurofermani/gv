...
(function(){
	...
	Slideshow = new Class({
		...
		options: {/*
			...
			onEnd: $empty,
			onStart: $empty,*/
		    accesskeys: {'first': {'key': 'shift left', 'label': 'Shift + Flacha Izquierda'}, 'prev': {'key': 'left', 'label': 'Flacha Izquierda'}, 'pause': {'key': 'p', 'label': 'P'}, 'next': {'key': 'right', 'label': 'Flecha Derecha'}, 'last': {'key': 'shift right', 'label': 'Shift + Flecha Derecha'}},
			captions: true,
			center: true,
