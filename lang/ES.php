...
// Editing may begin here
	...
	# search
	$l['search_keywords'] = 'Buscar';
	$l['search_button'] = 'Buscar';
	$l['search_results'] = 'Resultado de la búsqueda';
	$l['charerror'] = 'Al menos 4 caracteres se necesitan para realizar la búsqueda';
	$l['noresults'] = 'No se han encontrado datos ';
	$l['resultsfound'] = 'No se han encontrado datos';

	#comments
	$l['addcomment'] = 'Agregar comentario';
	$l['comment'] = 'Comentario';
	$l['comment_info'] = 'Cometario en';
	$l['page'] = 'Página';
